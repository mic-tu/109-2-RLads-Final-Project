...
首先，各項指標分數的部分，可以先從**私心推薦分數**對於教授和課堂獲得最粗略的認識，接著再以**學到東西**、**口條好**、**給分甜度**來判斷較細節的部分。至於**課業壓力分數**則是見仁見智，對推薦指數沒有什麼影響。

其次，**評論**的部分可以參考留言者的用詞。我們發現私心推薦指數高的教授，相關的評論幾乎都是正面的評價，沒有負面的字眼；但私心推薦指數低的教授，相關的評論雖然還是會出現正面評價，但負面字眼出現的頻率也不低。
